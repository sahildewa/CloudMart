...
![alt text](vpc/resourcemap.png)
![alt text](vpc/details.png)

---

### Amazon EC2

![alt text](ec2/detail.png)
![alt text](ec2/apache.png)
![alt text](ec2/security.png)
...
![alt text](<s3/Screenshot 2026-07-16 131644.png>)

---

### IAM Role

![alt text](iam/iam.png)

---

### Launch Template

![alt text](ec2/launchtemplate.png)

---

### Target Group

![alt text](<load balancer/targetgroup.png>)

---

### Application Load Balancer

![alt text](<load balancer/resourcemap.png>)
![alt text](<load balancer/detail.png>)
![alt text](<load balancer/rules.png>)

---

### Auto Scaling Group

![alt text](<Auto scaling/details.png>)
![alt text](<Auto scaling/instancemanagement.png>)
...
![alt text](website/mycart.png)
![alt text](website/myorder.png)
![alt text](website/admindashboard.png)
![alt text](website/userlist.png)
![alt text](website/catergories.png)
